...
export const ThirdSubHeader: React.FC<HeaderProps> = ({ navigation }) => {
  ...
  api
    ...
    .then((response: any) => {
      ...
      const transformedData = response.data.map((product: any) => {
        return {
          ...
          images: [
            "https://res.cloudinary.com/commercelayer/image/upload/f_auto,b_white/demo-store/skus/SWEATMXXFFFFFF000000LXXX_FLAT.png",
            "https://res.cloudinary.com/commercelayer/image/upload/f_auto,b_white/demo-store/skus/SWEATMXXFFFFFF000000LXXX_FLAT.png",
          ],
          color: "#000000",
        };
    ...
    .then((response: any) => {
      ...
      console.log(response.data,"heyyyyyyy")
      console.log(
        "Transformed Data in JSON Format:",
        JSON.stringify(jsonFormat, null, 2)
      );
